...

{
  users.users.ggg = {
    ...
    isNormalUser = true;
    description = "GGG";
    extraGroups = [ "wheel" "data-members" "grafana" "prometheus" "libvirtd" "nginx" ];
    hashedPassword = config.my.secrets.users.ggg.hashedPassword;
    openssh.authorizedKeys.keys = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGIbyyT77P4fzRh4Bfox1GQANs+P5VTrVADu5+k282fn ggg@home-server"
    ];
