...
[
  ...
  (fetchNuGet {
    ...
    version = "1.21.0";
    hash = "sha256-uV9aAW/KkPZprXGvxucnQ+uU03VGiwlPWLn950BF2PE=";
  })
  (fetchNuGet {
    pname = "Microsoft.AspNetCore.Authentication.JwtBearer";
    version = "9.0.0-rc.2.24474.3";
    hash = "sha256-Qm2QfnhrlQKv/Qf3EtJNkcTSUucWsWv9qxYrNy2FSzQ=";
  })
  (fetchNuGet {
    pname = "Microsoft.AspNetCore.OpenApi";
    version = "9.0.0-rc.2.24474.3";
    hash = "sha256-1E7rxN2pGwXlPstTVJc/nQ/ZsQXoC5fRxl40uyFZFzc=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "1.2.18";
    hash = "sha256-kTA5H1dl5fwbUTWshe3jZkRq6oJDIPJze6+vcu5cWj8=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    pname = "TwitchLib.EventSub.Core";
    version = "2.3.0";
    hash = "sha256-beMyCKlD0nwWFoRkCd3vG2JvA0L2DP38zWO4FNKxuuc=";
  })
  (fetchNuGet {
    pname = "TwitchLib.EventSub.Webhooks";
    version = "2.3.0";
    hash = "sha256-rgWLF1pgrCThIRueFeYW5izrR4+vO0ci7CEblDWyqHc=";
  })
  (fetchNuGet {
    pname = "ZoneTree";
    version = "1.8.3";
    hash = "sha256-XejAVQ+BPGW+NoNPjowM0YpQHqZS1ViGvls7maZSpWw=";
  })
  (fetchNuGet {
    pname = "ZstdNet";
    version = "1.4.5";
